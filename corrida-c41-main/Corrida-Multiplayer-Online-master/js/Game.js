class Game {
  ...
  start() {
    ...
    this.addSprites(combustiveis, 4, fuelImage, 0.02);

    // Adicionar sprite de moeda no jogo
    this.addSprites(moeda, 18, powerCoinImage, 0.09);
  ...
  showFuelBar() {
    ...
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 350, player.combustivel, 20);
    noStroke();
    pop();
  }
  ...
  handlePowerCoins(index) {
    cars[index - 1].overlap(moeda, function(collector, collected) {
      player.score += 21;
      player.update();
      //o sprite é coletado no grupo de colecionáveis que desencadeou
      //o evento
